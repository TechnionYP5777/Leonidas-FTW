    ...
    public enum TipperGroup {
        ...
        /*
            static IPreferenceStore store() {
                return Plugin.il.org.spartan.ispartanizer.plugin().getPreferenceStore();
            }
        */
        ...
        /*  deals with eclipse il.org.spartan.ispartanizer.plugin preferences:
            public boolean isEnabled() {
                return Plugin.il.org.spartan.ispartanizer.plugin() == null || store().getBoolean(id);
            }
        */
