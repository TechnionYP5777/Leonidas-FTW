...
public abstract class MatcherBuilder {
    ...
    //TODO correct
    public MatcherBuilder initialzeSourceCode(PsiFile file) {
     ...
     */
    public MatcherBuilder butNot(int i, Template template) {
     ...
     * @return the current matcher for fluent code
     */
    public MatcherBuilder andAlso(int i, Template template) {
