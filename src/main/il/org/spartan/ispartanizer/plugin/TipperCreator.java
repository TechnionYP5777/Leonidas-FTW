...
public class TipperCreator extends JFrame {
    ...
    private int startOfMatchedFrom = 0;
    private int endOfMatchedFrom = 0;
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    public TipperCreator(PsiElement element) {
        ...
        selectGenerics.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                super.mouseClicked(e);
                if (fromCode.getSelectedText() == null || StubName.valueOfStringExpression(fromCode.getSelectedText()) == null) {//change
                    return;
                }
        ...
        matchGeneric.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                StubName stub1 = StubName.valueOfStringExpression(fromCode.getText().substring(startOfMatchedFrom, endOfMatchedFrom));
                StubName stub2 = StubName.valueOfStringExpression(toCode.getSelectedText());
                if (!stub1.equals(stub2)) {
                    return;
                }
                String toSelected = toCode.getSelectedText();
                String replaceString = toSelected.substring(0, toSelected.length() - 1) + genericElementIndex + ")";
    ...
    private void $$$setupUI$$$() {
        ...
        panel2.add(toCode, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_WANT_GROW, new Dimension(300, 300), new Dimension(150, 50), null, 0, false));
        fromCode = new JTextArea();
        panel2.add(fromCode, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_WANT_GROW, new Dimension(300, 300), new Dimension(150, 50), null, 0, false));
