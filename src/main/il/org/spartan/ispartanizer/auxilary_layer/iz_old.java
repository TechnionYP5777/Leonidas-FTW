...
//        return iz_old.infixExpression(¢) && iz_old.comparison(az.infixExpression(¢));
//    }
...
//        return iz_old.nodeTypeIn(¢, CHARACTER_LITERAL, NUMBER_LITERAL, NULL_LITERAL, THIS_EXPRESSION)
//                || nodeTypeEquals(¢, PREFIX_EXPRESSION) && iz_old.constant(extract.core(((PrefixExpression) ¢).getOperand()));
//    }
...
//    }
    ...
    static boolean deMorgan(final PsiBinaryExpression ¢) {
        return ¢ != null && iz_old.deMorgan(¢.getOperationSign());
    }
...
//        if (child == null || parent == null || !iz_old.enhancedFor(parent))
//            return false;
...
//        return iz_old.nodeTypeEquals(¢, FIELD_ACCESS);
//    }
...
//                : iz_old.simpleName(typeName) && identifier(identifier, az.simpleName(typeName));
//    }
...
//        return iz_old.nodeTypeEquals(¢, VARIABLE_DECLARATION_STATEMENT);
//    }
//
//    static iz_old izParser(final String name) {
//        return new iz_old() {
...
//    }
//
//    static iz_old izParser(final Throwable ¢) {
//        return new iz_old() {
//            @Override public String toString() {
...
//        return last(s, statements(b)) && iz_old.methodDeclaration(parent(b));
//    }
//
...
//        return iz_old.nodeTypeEquals(¢, MEMBER_REF);
//    }
//
...
//        return iz_old.nodeTypeEquals(¢, METHOD_DECLARATION);
//    }
//
...
//        return iz_old.nodeTypeEquals(¢, METHOD_INVOCATION);
//    }
//
//    static boolean modifier(final ASTNode ¢) {
//        return iz_old.nodeTypeEquals(¢, MODIFIER);
//    }
//
...
//        return iz_old.nodeTypeIn(¢, ARRAY_ACCESS, ARRAY_CREATION, BOOLEAN_LITERAL, CAST_EXPRESSION, CHARACTER_LITERAL, CLASS_INSTANCE_CREATION, FIELD_ACCESS,
...
//        return iz_old.nodeTypeEquals(¢, NORMAL_ANNOTATION);
//    }
//
...
//        return iz_old.nodeTypeEquals(¢, NULL_LITERAL);
//    }
//
//    static boolean number(final Expression ¢) {
//        return iz_old.numberLiteral(¢) && (type.isInt(¢) || type.isDouble(¢) || type.isLong(¢));
//    }
//
//    static boolean numberLiteral(final ASTNode ¢) {
//        return iz_old.nodeTypeEquals(¢, NUMBER_LITERAL);
//    }
//
...
//        return iz_old.nodeTypeIn(¢, new int[] { CHARACTER_LITERAL, NUMBER_LITERAL });
//    }
//
//    static boolean parenthesizedExpression(final ASTNode ¢) {
//        return iz_old.nodeTypeEquals(¢, PARENTHESIZED_EXPRESSION);
//    }
//
...
//        return iz_old.nodeTypeEquals(¢, POSTFIX_EXPRESSION);
//    }
//
//    /** @param pattern JD
...
//        return iz_old.nodeTypeEquals(¢, PREFIX_EXPRESSION);
//    }
//
//    static boolean prefixMinus(final Expression ¢) {
//        return iz_old.prefixExpression(¢) && az.prefixExpression(¢).getOperator() == wizard.MINUS1;
//    }
//
//    /** @param ¢ JD
//     * @return */
...
//        return number(¢) || iz_old.prefixMinus(¢) && iz_old.number(az.prefixExpression(¢).getOperand());
//    }
//
...
//        return iz_old.nodeTypeEquals(¢, QUALIFIED_NAME);
//    }
//
...
//        return iz_old.nodeTypeEquals(¢, RETURN_STATEMENT);
//    }
//
...
//        return iz_old.nodeTypeIn(¢, new int[] { RETURN_STATEMENT, BREAK_STATEMENT, CONTINUE_STATEMENT, THROW_STATEMENT });
//    }
//
...
//        return iz_old.nodeTypeIn(¢, BOOLEAN_LITERAL, CHARACTER_LITERAL, NULL_LITERAL, NUMBER_LITERAL, QUALIFIED_NAME, SIMPLE_NAME, STRING_LITERAL,
...
//        return iz_old.nodeTypeEquals(¢, SIMPLE_NAME);
//    }
//
//    static boolean singleMemberAnnotation(final ASTNode ¢) {
//        return iz_old.nodeTypeEquals(¢, SINGLE_MEMBER_ANNOTATION);
//    }
//
...
//        return ¢ != null && iz_old.singletonStatement(then(¢));
//    }
//
//    static boolean singleVariableDeclaration(final ASTNode ¢) {
//        return iz_old.nodeTypeEquals(¢, SINGLE_VARIABLE_DECLARATION);
//    }
//
//    /** @param ¢ JD
...
//        return iz_old.nodeTypeEquals(¢, THIS_EXPRESSION);
//    }
//
//    /** Determine whether a node is <code><b>this</b></code> or
//     * <code><b>null</b></code>
...
//        return iz_old.nodeTypeIn(¢, new int[] { NULL_LITERAL, THIS_EXPRESSION });
//    }
//
//    static boolean tryStatement(final ASTNode ¢) {
//        return iz_old.nodeTypeEquals(¢, TRY_STATEMENT);
//    }
//
//    static boolean typeDeclaration(final ASTNode ¢) {
//        return ¢ != null && iz_old.nodeTypeEquals(¢, TYPE_DECLARATION);
//    }
//
//    /** @param ¢ JD
...
//            if (!iz_old.pseudoNumber(¢))
//                return false;
//        return true;
//    }
//
//    static boolean variableDeclarationExpression(final ASTNode $) {
//        return iz_old.nodeTypeEquals($, VARIABLE_DECLARATION_EXPRESSION);
//    }
//
//    /** @param $
//     * @return */
//    static boolean variableDeclarationFragment(final ASTNode $) {
//        return iz_old.nodeTypeEquals($, VARIABLE_DECLARATION_FRAGMENT);
//    }
//
//    /** @param pattern JD
...
//        return iz_old.nodeTypeEquals(x, WHILE_STATEMENT);
//    }
//
//    static boolean wildcardType(final ASTNode ¢) {
//        return iz_old.nodeTypeEquals(¢, WILDCARD_TYPE);
//    }
//
//    /** @param ¢ JD
